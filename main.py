    ...
    if fileTypeSpesific[0].strip() == "PDF document":
        ...
        if len(reader.pages) != 0:
            ...
            if __name__ == '__main__':
                ([ReadFirstHalfOfFile(charachterString[:halfIndexmark], numOfNum, filename, full_path, reportSINInfo),ReadFirstHalfOfFile(charachterString[halfIndexmark:],numOfNum,filename,full_path,reportSINInfo)])
    ...
    for dirpath, dirnames, filenames in os.walk(directory):
        for filename in filenames:
            ...
            try:
                ...
                readAndProcess(fileTypeSpesific,filename,full_path,reportSINInfo)
...
print(f'This is the time: {time.time()}')
